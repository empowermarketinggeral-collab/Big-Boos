...
- **SQL**: migrações numeradas em `supabase/NN_nome.sql` (a próxima é a 63). O utilizador cola-as à mão no SQL Editor do Supabase, por ordem. Escreve sempre migrações que se possam correr uma vez e diz-lhe o que correr.
